...
<div id="container">
	<div id="header">
		User Task Form: DemoProcess.BackOfficeReceivesRequest
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		<label for="name">RequestNum_in</label>
                            		<div class="div_checkbox">
                            		</div>
                            		<label for="name">CustomerName_in</label>
                            		<div class="div_checkbox">
                            		</div>
                            		<label for="name">RequestType_in</label>
                            		<div class="div_checkbox">
                            		</div>
